...
from theodwyn.stacks.debug.debug_autonomy_stack import DebugAutoStack
from rohan.data.classes                         import StackConfiguration
from time                                       import time

if __name__ == "__main__":

    with open("./config/debug_autonomy_config.json") as file:
    ...
    config.network_classes = [ZMQDish,ViconConnection,Adafruit_PCA9685,SabertoothSimpleSerial,SabertoothSimpleSerial]

    stack = DebugAutoStack( config=config )
    stack.spin()
